				...
				{stageDetails && (
					<div>
						...
						<p className="d-flex align-items-center">
							{" "}
							{/* Flex container for status and buttons */}
							...
							<div className="ms-3">
								...
								>
									<Button
										...
										disabled={
											isUpdatingStatus || stageDetails.status === "finished"
										}
									>
										<FaCheckCircle />
									</Button>
								...
								<OverlayTrigger
									placement="top"
									overlay={
										<Tooltip id="tooltip-top">Mark as Unfinished</Tooltip>
									}
								>
									<Button
										...
										disabled={
											isUpdatingStatus || stageDetails.status === "unfinished"
										}
									>
								...
								>
									<Button
										...
										disabled={
											isUpdatingStatus || stageDetails.status === "pending"
										}
									>
										<FaClockRotateLeft />
									</Button>
