...
def test_replace_node_working_dir():
    ...
    assert replace_node_working_dir(ref_path, ref_nwd, inp_nwd).as_posix() == "nodes/grp/MyNode/node-meta.json"
    ...
    assert replace_node_working_dir(ref_path, ref_nwd, inp_nwd).as_posix() == "nodes/MyNode/node-meta.json"
    ...
    assert replace_node_working_dir(ref_path, ref_nwd, inp_nwd).as_posix() == "nodes/MyNode_1/node-meta.json"
